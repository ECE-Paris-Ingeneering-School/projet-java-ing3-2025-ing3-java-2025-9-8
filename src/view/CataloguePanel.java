...
public class CataloguePanel extends JPanel {
    ...
    public CataloguePanel(User user) {
        ...
        productsPanel.add(createProductCard("Chaussettes de yoga", 12.0, "chaussettes.png", 1001));
        productsPanel.add(createProductCard("Poids", 15.0, "poids.png", 2003));
        productsPanel.add(createProductCard("Tapis de yoga", 30.0, "tapis.png", 2004));
        productsPanel.add(createProductCard("Barres de céréales", 5.0, "barres.png", 1002));
        productsPanel.add(createProductCard("Bouteilles énergisantes", 8.0, "bouteilles.png", 1003));
        productsPanel.add(createProductCard("Brassières de sport", 25.0, "brassieres.png", 2001));
        productsPanel.add(createProductCard("Ensemble de sport", 45.0, "ensemble.png", 2002));
        productsPanel.add(createProductCard("Serviettes", 10.0, "serviettes.png", 1004));
